...
public class O1 {
    public static void main(String[] args) {
        ...
        if (lonn < t1) {
            ...
            System.out.print("Dinn skatt: " + (int)((lonn-t1)*s1)+0.5);
        } else if (lonn < t3) {
            System.out.println("Trinn 2");
            System.out.print("Dinn skatt: " + (int)((((lonn-t2)*s2)+0.5)+((t2-t1)*s1)));
            //Tar lønn - 306 k og overskuddet blir skatta; deretter plusser vi på skatt fra forrige trinn.
        }else if (lonn < t4) {
            System.out.println("Trinn 3");
            System.out.print("Dinn skatt: " + (int)((((lonn-t3)*s3)+0.5)+((t2-t1)*s1)+((t3-t2)*s2)));
            ...
            System.out.print("Dinn skatt: " + (int)((((lonn-t4)*s4)+0.5)+((t2-t1)*s1)+((t3-t2)*s2)+((t4-t3)*s3)));
            ...
            System.out.print("Dinn skatt: " + (int)((((lonn-t5)*s5)+0.5)+((t2-t1)*s1)+((t3-t2)*s2)+((t4-t3)*s3)+((t5-t4)*s4)));
        }
